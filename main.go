...
var dbRegistry = map[string]func() (KVStore, error){
	...
	"v4_idx": func() (KVStore, error) { return v4_idx.NewV4Store(), nil },
	"v5": func() (KVStore, error) { return v5.NewV5Store(), nil },
	"v6": func() (KVStore, error) { return v6.NewV6Store(), nil },
}
